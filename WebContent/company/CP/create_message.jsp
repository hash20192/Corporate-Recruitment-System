...
<form id="test-form" class="message-box mfp-hide" action="${pageContext.request.contextPath}/Company_Controller">
	...
	<h1>Message </h1><hr/>
		...
		<ul>
			...
			<li>
				...
				<input id="from" name="from" type="email" value=<%=company.getCompany_email()%> placeholder="example@domain.com" required readonly >
			</li>
			<li>
