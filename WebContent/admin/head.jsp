...
<div id="logo">
<a href="admin.jsp"><img alt="CRS" src="${pageContext.request.contextPath}/images/crs_logo.png"/>
</a>
</div>
...
<div  id="drop_menu">
<div id="dd" class="wrapper-dropdown-2" tabindex="1">menu<span><img src="${pageContext.request.contextPath}
/images/menu.png"/></span>
